"""The client's full Uniformat estimate structure, Levels 3 and 4.

GENERATED from fixtures/ACME Studios - Uniformat Estimate Detail Structure.xlsx
(every row whose UF CODE matches a Level 3 `X0000` or Level 4 `X0000.00`
pattern — Level 5 quantity line items are deliberately excluded, see
codes.py's module docstring). Regenerate with:

    PYTHONPATH=src:. python3 scripts/regenerate_acme_reference.py

and never hand-edit: tests/test_acme_codes_fixture.py asserts this dict is
byte-for-byte equal to what the spreadsheet says, both directions.

2026-09-07: added when the 'Conditioned/All/<source>' republish put every
non-wall object in front of a reviewer and the function could only say "not
conditioned" — and, worse, said the client had no codes for those
categories. It does: 526 Level 4 codes across every Uniformat division, of
which the 21 in codes.ACME_WALL_CODES are the ones this function currently
derives. This module is the description lookup for every code a reviewer
could meet; ACME_WALL_CODES stays the scope of what gets predicted.
"""
...
ACME_CODES: dict[str, str] = {
    ...
    'A1010.40': 'Mat Foundations',
    'A1010.90': 'Standard Foundation Supplementary Components',
    'A1020': 'Special Foundations',
    'A1020.10': 'Driven Piles',
    'A1020.15': 'Bored Piles',
    'A1020.20': 'Caissons',
    'A1020.30': 'Special Foundations',
    'A1020.40': 'Foundation Anchors',
    'A1020.50': 'Underpinning',
    'A2000': 'Subgrade Enclosures',
    ...
    'A4000': 'Slabs-on-Grade',
    'A4010': 'Standard Slabs-on-Grade',
    'A4010.10': 'Standard Slabs-on-Grade',
    'A4020': 'Structural Slabs-on-Grade',
    'A4020.10': 'Structural Slabs-on-Grade',
    'A4030': 'Slab Trenches',
    'A4030.10': 'Slab Trenches',
    'A4040': 'Pits and Bases',
    'A4040.10': 'Pits and Bases',
    'A4090': 'Slab-On-Grade Supplementary Components',
    'A4090.10': 'Perimeter Insulation',
    'A4090.20': 'Vapor Retarder',
    'A4090.30': 'Waterproofing',
    'A4090.50': 'Mud Slab',
    'A4090.60': 'Subbase Layer',
    'A6000': 'Water and Gas Mitigation',
    'A6010': 'Building Subdrainage',
    'A6010.10': 'Foundation Drainage',
    'A6010.20': 'Underslab Drainage',
    'A6020': 'Off-Gassing Mitigation',
    'A6020.10': 'Radon Mitigation',
    'A6020.50': 'Methane Mitigation',
    'A9000': 'Substructure Related Activities',
    'A9010': 'Substructure Excavation',
    'A9010.10': 'Excavation and Backfill',
    'A9020': 'Construction Dewatering',
    'A9020.10': 'Construction Dewatering',
    'A9030': 'Excavation Support',
    'A9030.10': 'Excavation Support and Protection Systems',
    'A9030.20': 'Cofferdams',
    'B1000': 'Superstructure',
    ...
    'B1020.20': 'Roof Decks, Slabs, and Sheathing',
    'B1020.30': 'Canopy Construction',
    'B1020.90': 'Roof Construction Supplementary Components',
    'B1080': 'Stairs',
    'B1080.10': 'Stair Construction',
    'B1080.50': 'Stair Railings',
    'B1080.60': 'Fire escapes',
    'B1080.70': 'Metal Walkways',
    'B1080.80': 'Ladders',
    'B2000': 'Exterior Vertical Enclosures',
    'B2010': 'Exterior Walls',
    'B2010.10': 'Exterior Wall Veneer',
    'B2010.20': 'Exterior Wall Back-up Construction',
    'B2010.30': 'Exterior Wall Interior Skin',
    'B2010.40': 'Fabricated Exterior Wall Assemblies',
    ...
    'B2020.10': 'Exterior Operating Windows',
    'B2020.20': 'Exterior Fixed Windows',
    'B2020.30': 'Exterior Window Wall',
    'B2020.50': 'Exterior Special Function Windows',
    'B2050': 'Exterior Doors and Grilles',
    'B2050.10': 'Exterior Entrance Doors',
    'B2050.20': 'Exterior Utility Doors',
    'B2050.30': 'Exterior Oversize Doors',
    'B2050.40': 'Exterior Special Function Doors',
    'B2050.60': 'Exterior Grilles',
    'B2050.70': 'Exterior Gates',
    'B2050.90': 'Exterior Door Supplementary Components',
    'B2070': 'Exterior Louvers and Vents',
    'B2070.10': 'Exterior Louvers',
    'B2070.50': 'Exterior Vents',
    'B2080': 'Exterior Wall Appurtenances',
    'B2080.30': 'Exterior Opening Protection Devices',
    'B2080.50': 'Exterior Balcony Walls and Railings',
    'B2080.70': 'Exterior Fabrications and Trim',
    'B2080.80': 'Bird Control Devices',
    'B2090': 'Exterior Wall Specialties',
    'B2090.10': 'Wall specialties',
    'B2090.20': 'Exterior Clocks',
    'B2090.30': 'Exterior Signage',
    'B3000': 'Exterior Horizontal Enclosures',
    'B3010': 'Roofing',
    'B3010.10': 'Steep Slope Roofing',
    'B3010.50': 'Low-Slope Roofing',
    'B3010.70': 'Canopy Roofing',
    'B3010.90': 'Roofing Supplementary Components',
    'B3020': 'Roof Appurtenances',
    'B3020.10': 'Roof Accessories',
    'B3020.30': 'Roof Specialties',
    'B3020.70': 'Rainwater Management',
    'B3040': 'Traffic Bearing Horizontal Enclosures',
    'B3040.10': 'Traffic Bearing Coatings',
    'B3040.30': 'Horizontal Waterproofing Membrane',
    'B3040.50': 'Wear Surfaces',
    'B3060': 'Horizontal Openings',
    'B3060.10': 'Roof Windows and Skylights',
    'B3060.50': 'Vents and Hatches',
    'B3080': 'Overhead Exterior Enclosures',
    'B3080.20': 'Exterior Soffits/Ceilings',
    'C1000': 'Interior Construction',
    ...
    'C1020.10': 'Interior Windows',
    'C1020.50': 'Interior Special Function Windows',
    'C1020.90': 'Interior Window Supplementary Components',
    'C1030': 'Interior Doors',
    'C1030.10': 'Interior Swinging Doors',
    'C1030.20': 'Interior Entrance Doors',
    'C1030.25': 'Interior Sliding Doors',
    'C1030.30': 'Interior Folding Doors',
    'C1030.40': 'Interior Coiling Doors',
    'C1030.50': 'Interior Panel Doors',
    'C1030.70': 'Interior Special Function Doors',
    'C1030.80': 'Interior Access Doors and Panels',
    'C1030.90': 'Interior Door Supplementary Components',
    'C1040': 'Interior Grilles and Gates',
    'C1040.10': 'Interior Grilles',
    'C1040.50': 'Interior Gates',
    'C1060': 'Raised Floor Construction',
    'C1060.10': 'Access Flooring',
    'C1060.30': 'Platform/Stage Floors',
    'C1070': 'Suspended Ceiling Construction',
    'C1070.10': 'Acoustical Suspended Ceilings',
    'C1070.20': 'Suspended Plaster and Gypsum Board Ceilings',
    'C1070.50': 'Specialty Suspended Ceilings',
    'C1070.70': 'Special Function Suspended Ceilings',
    'C1070.90': 'Ceiling Suspension Components',
    'C1090': 'Interior Specialties',
    'C1090.10': 'Interior Railings and Handrails',
    'C1090.15': 'Interior Louvers',
    'C1090.20': 'Information Specialties',
    'C1090.25': 'Compartments and Cubicles',
    'C1090.30': 'Service Walls',
    'C1090.35': 'Wall and Door Protection',
    ...
    'C2020.10': 'Interior Fabrications',
    'C2030': 'Flooring',
    ...
    'C2040.80': 'Concrete Stair Finish',
    ...
    'D2050.10': 'General Service Compressed-Air',
    'D2060': 'Process Support Plumbing Systems',
    'D2060.10': 'Compressed-Air Systems',
    'D2060.20': 'Vacuum Systems',
    'D2060.30': 'Gas Systems',
    'D2060.31': 'Gas Systems - CO2 - Carbon Dioxide',
    'D2060.32': 'Gas Systems - N2 - Nitrogen',
    'D2060.33': 'Gas Systems - O2 - Oxygen',
    'D2060.34': 'Gas Systems - Miscellaneous',
    'D2060.40': 'Chemical-Waste Systems',
    'D2060.41': 'Process Waste Systems',
    'D2060.42': 'Biowaste Inactivation',
    'D2060.43': 'Specialty Process Drainage',
    'D2060.44': 'Chemical Drainage',
    'D2060.45': 'Vent Piping',
    'D2060.50': 'Processed Water Systems',
    'D2060.51': 'Process Chilled Water Systems',
    'D2060.52': 'Process Heating Water Systems',
    'D2060.53': 'Process Steam Systems',
    'D2060.54': 'Purified Water Systems',
    'D2060.55': 'Process Piping Systems - Solids',
    'D2060.56': 'Process Piping Systems - NaOH',
    'D2060.57': 'Process Piping Systems - NaCL',
    'D2060.60': 'Process Piping Systems - Liquids',
    'D2060.61': 'Process Piping Systems - Clean In Place (CIP)',
    'D2060.62': 'Process Piping Systems - TCM',
    'D2060.67': 'Process Piping Systems - LN2 - Liquid Nitrogen',
    'D2060.90': 'Process Support Plumbing System Supplementary Components',
    'D3000': 'Heating, Ventilation, and Air Conditioning (HVAC)',
    ...
    'D3030.70': 'Decentralized Cooling Equipment',
    ...
    'D3050.60': 'HVAC Air Distribution Components',
    ...
    'D3090': 'HVAC Supplementary Components',
    'D3090.10': 'HVAC Supplementary Components',
    'D4000': 'Fire Protection',
    ...
    'D6000': 'Communications',
    'D6005': 'Structured Cabling',
    'D6005.10': 'Communications Equipment Room Fittings',
    'D6005.20': 'Communications Cabling',
    'D6005.30': 'Communications Connecting',
    'D6010': 'Data Communications',
    'D6010.10': 'Data Communications Network Equipment',
    'D6010.20': 'Data Communications Hardware',
    'D6010.30': 'Data Communications Peripheral Equipment',
    ...
    'D6090.10': 'Communications Supplementary Components',
    'D7000': 'Electronic Safety and Security',
    ...
    'D7050.15': 'Mass Notification',
    'D7050.20': 'Radiation Detection and Alarm',
    'D7050.30': 'Gas Detection and Alarm',
    ...
    'D7090.10': 'Electronic Safety and Security Supplementary Components',
    'D8000': 'Integrated Automation',
    ...
    'E1030.35': 'Commercial Laundry and Dry Cleaning Equipment',
    ...
    'E1030.90': 'Commercial Equipment Supplementary Components',
    ...
    'E1080': 'Process Equipment, Instrumentation and Controls',
    'E1080.10': 'Process Equipment - Procurement',
    'E1080.20': 'Process Equipment - Installation',
    'E1080.30': 'Process Instrumentation and Controls',
    'E1080.40': 'Process Automation',
    ...
    'E2090': 'Furnishings Supplementary Components',
    'E2090.10': 'Furnishings Supplementary Components',
    ...
    'F3090': 'Demolition and Moving Supplementary Components',
    'F3090.10': 'Demolition and Moving Supplementary Components',
    'G1000': 'Site Preparation',
    'G1010': 'Site Clearing',
    ...
    'G1090': 'Site Preparation Supplementary Components',
    'G1090.10': 'Site Preparation Supplementary Components',
    'G2000': 'Site Improvements',
    'G2010': 'Roadways',
    ...
    'G2010.90': 'Site Improvements Supplementary Components',
    'G2020': 'Parking Lots',
    ...
    'G2020.90': 'Parking Lot Supplementary Components',
    'G2030': 'Pedestrian Plazas and Walkways',
    'G2030.10': 'Pedestrian Pavement',
    'G2030.20': 'Pedestrian Pavement Curbs',
    ...
    'G2030.90': 'Pedestrian Plazas and Walkways Supplementary Components',
    'G2040': 'Airfields',
    ...
    'G3000': 'Liquid and Gas Site Utilities',
    ...
    'G3090.10': 'Liquid and Gas Site Utilities Supplementary Components',
    'G4000': 'Electrical Site Improvements',
    ...
    'G4010.50': 'Electrical Switchgear and Protection Devices - High-Voltage',
    'G4010.51': 'Electrical Switchgear and Protection Devices - Medium Voltage',
    ...
    'G9000': 'Miscellaneous Site Construction',
    'G9010': 'Tunnels',
    ...
    'Z1000': 'Overall general requirements',
    'Z1010': 'General Requirements - Misc.',
    'Z1010.10': 'Allowances',
    ...
    'Z2040': 'Permitting',
    'Z2040.10': 'Overall plan review fees',
}
