...
# ---------------------------------------------------------------------------
# Uniformat heuristic lookup
# ---------------------------------------------------------------------------

# (keyword_in_combined_text, uniformat_code, description) — ordered by specificity
HEURISTIC_MAP: list[tuple[str, str, str]] = [
    ("curtain wall", "B2050", "Curtain Walls / Exterior Windows"),
    ("curtain",      "B2050", "Curtain Walls / Exterior Windows"),
    ("glazing",      "B2050", "Curtain Walls / Exterior Windows"),
    ("storefront",   "B2050", "Curtain Walls / Exterior Windows"),
    ("retaining",    "A2020", "Basement Walls"),
    ("basement",     "A2020", "Basement Walls"),
    ("foundation",   "A2020", "Basement Walls"),
    ("below grade",  "A2020", "Basement Walls"),
    ("shear",        "B2010", "Exterior Walls"),
    ("exterior",     "B2010", "Exterior Walls"),
    ("facade",       "B2010", "Exterior Walls"),
    ("cmu",          "B2010", "Exterior Walls"),
    ("scmu",         "B2010", "Exterior Walls"),
    ("masonry",      "B2010", "Exterior Walls"),
    ("brick",        "B2010", "Exterior Walls"),
    ("demising",     "C1010", "Interior Partitions"),
    ("firewall",     "C1010", "Interior Partitions"),
    ("partition",    "C1010", "Interior Partitions"),
    ("interior",     "C1010", "Interior Partitions"),
]

# Revit Function parameter → Uniformat (highest-confidence heuristic signal)
...
DEFAULT_CODE = ("B2010", "Exterior Walls (default fallback)")
FEET_TO_MM = 304.8
